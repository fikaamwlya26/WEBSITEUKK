    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        ...
        <a class="navbar-brand d-flex align-items-center" href="#">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="mynavbar">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ route('user1.index') }}" data-section="hero-section">Home</a></li>
                    <li class="nav-item"><a class="nav-link" href="#Product" data-section="gallery-section">Product</a></li>

                    <!-- Search Icon -->
                    <li class="nav-item">
                        <a href="#cari" class="nav-link">
         ...
         <!-- section cari-->
        <section class="center-container" id="cari">
            ...
            <form action="" method="GET" class="search-box bg-white rounded">
        ...
        <section id="Product" class="gallery-section">
            ...
            <div class="row">
                @if($products->isNotEmpty())
                    @foreach($products as $product) <!-- HAPUS .take(4) -->
                            ...
                            <div class="card gallery-card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <button class="btn btn-pink" onclick="addToCart({{ $product->id }})">
