                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Silakan masukkan email dan password baru Anda.</p>
                                    </div>
                                    <form class="user" action="{{ route('password.update') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" name="password" required placeholder="New Password">
                                        </div>
                                        <div class="form-group">
